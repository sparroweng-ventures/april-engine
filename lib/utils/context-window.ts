...
const MODEL_CONTEXT_WINDOWS: Record<string, ModelContextInfo> = {
  ...
  'gpt-5.6-terra': { contextWindow: 1050000, outputTokens: 128000 },
  'gpt-5.6-sol': { contextWindow: 1050000, outputTokens: 128000 },
...
const MODEL_TO_ENCODING: Record<string, TiktokenEncoding> = {
  ...
  'gpt-5.6-terra': 'cl100k_base',
  'gpt-5.6-sol': 'cl100k_base',
