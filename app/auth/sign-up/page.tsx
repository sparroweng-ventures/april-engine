...
export default function Page() {
  return (
    <main className="min-h-svh bg-background p-3 sm:p-5 lg:p-7">
      <div className="mx-auto grid min-h-[calc(100svh-1.5rem)] w-full max-w-6xl overflow-hidden rounded-[28px] border border-border/60 bg-card shadow-[0_24px_80px_rgba(23,28,12,0.10)] sm:min-h-[calc(100svh-2.5rem)] lg:h-[calc(100svh-3.5rem)] lg:min-h-0 lg:grid-cols-[0.92fr_1.08fr]">
        <section className="flex items-center overflow-y-auto px-6 py-7 sm:px-10 lg:px-14 lg:py-6 xl:px-16">
        ...
        <section
          aria-hidden="true"
          className="relative hidden min-h-0 overflow-hidden border-l border-border/40 lg:block"
        >
